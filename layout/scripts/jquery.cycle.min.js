...
(function (e, t) {
  ...
  function f(n, r, o, a, f) {
    ...
    if (!e.support.opacity && y.cleartype)
    ...
    var T =
      (y.containerResize || y.containerResizeHeight) && n.innerHeight() < 1;
    if (T) {
      var N = 0,
        C = 0;
      ...
      if (y.containerResize && N > 0 && C > 0)
        n.css({ width: N + "px", height: C + "px" });
      if (y.containerResizeHeight && C > 0) n.css({ height: C + "px" });
    }
    var _ = false;
    if (y.pause)
      n.bind("mouseenter.cycle", function () {
        _ = true;
        this.cyclePause++;
        s(w, true);
  ...
  function p(n, i, s, o) {
    ...
    if (
      ...
      !u.cyclePause &&
      !i.bounce &&
      ((i.autostop && --i.countdown <= 0) ||
        (i.nowrap && !i.random && i.nextSlide < i.currSlide))
    ) {
      if (i.end) i.end(i);
      return;
    }
    ...
    if ((s || !u.cyclePause) && i.nextSlide != i.currSlide) {
      ...
      if (i.multiFx) {
        ...
        else if (!o && (i.lastFx === t || --i.lastFx < 0))
          i.lastFx = i.fxs.length - 1;
        c = i.fxs[i.lastFx];
      }
      if (i.oneTimeFx) {
        c = i.oneTimeFx;
      ...
      else if (e.isFunction(e.fn.cycle[i.fx]))
    ...
    if (l && i.pager)
      i.updateActivePagerLink(i.pager, i.currSlide, i.activePagerClass);
  }
  function d(e, t, n, i) {
    if (n.timeoutFn) {
  ...
  e.fn.cycle = function (t, n) {
    ...
    return this.each(function () {
      ...
      var v = h.continuous
        ? 10
        : d(c[h.currSlide], c[h.nextSlide], h, !h.backwards);
      if (v) {
        v += h.delay || 0;
        if (v < 10) v = 10;
        r("first timeout: " + v);
  ...
  e.fn.cycle.createPagerAnchor = function (t, n, i, o, u) {
    ...
    if (!/^click/.test(u.pagerEvent) && !u.allowPagerClickBubble)
  ...
  e.fn.cycle.commonReset = function (t, n, r, i, s, o) {
    ...
    if (r.slideResize && i !== false && n.cycleW > 0)
      r.cssBefore.width = n.cycleW;
    if (r.slideResize && s !== false && n.cycleH > 0)
      r.cssBefore.height = n.cycleH;
...
(function (e) {
  ...
  e.fn.cycle.transitions.toss = function (t, n, r) {
    ...
    r.before.push(function (t, n, r) {
      e.fn.cycle.commonReset(t, n, r, true, true, true);
      if (!r.animOut.left && !r.animOut.top)
        e.extend(r.animOut, { left: i * 2, top: -s / 2, opacity: 0 });
